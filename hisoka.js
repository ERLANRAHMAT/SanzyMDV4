...
m.reply(mess.wait)
	let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/bocil' },
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/santuy' },
                    caption: `Random ${command}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/api/asupan/gheayubi' },
                    caption: `Random ${command}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
...
let buttons = [
                ...
                let buttonMessage = {
                    video: { url: 'https://api-betabot.herokuapp.com/asupan/ukhty' },
...
Kalian Bisa Mendukung Bot Ini Dengan Cara Donasi Ya Ka🤗 Terimakasih `
              let button = [{
                ...
                hisoka.send5ButImg(m.chat, anu, hisoka.user.name, donasi.thumb, button)
            }
            break
